<script>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#categoryauditTable').DataTable({
            "ajax": {
                "url": categoryAuditReadRoute,
                "type": "GET",
            },
            destroy: true,
            info: true,
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<button type="button" class="btn btn-sm btn-success view-category-details-btn" ' +
                               'data-payload=\'' + (rawData || '{}') + '\' ' +
                               'data-bs-toggle="modal" data-bs-target="#auditCategoryDetailsModal">' +
        ...
        $(document).on('click', '.view-category-details-btn', function() {
            ...
            try {
                ...
                $('#jsonPayloadDisplayCategory').html(highlightedJson);
            } catch (e) {
                $('#jsonPayloadDisplayCategory').text(rawData || 'No details available.');
            }
        });
    });
</script>