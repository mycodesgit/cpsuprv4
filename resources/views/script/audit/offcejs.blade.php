<script>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#officeauditTable').DataTable({
            "ajax": {
                "url": officeAuditReadRoute,
                "type": "GET",
            },
            destroy: true,
            info: true,
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<button type="button" class="btn btn-sm btn-success view-office-details-btn" ' +
                               'data-payload=\'' + (rawData || '{}') + '\' ' +
                               'data-bs-toggle="modal" data-bs-target="#auditOfficeDetailsModal">' +
        ...
        $(document).on('click', '.view-office-details-btn', function() {
            ...
            try {
                ...
                $('#jsonPayloadDisplayOffice').html(highlightedJson);
            } catch (e) {
                $('#jsonPayloadDisplayOffice').text(rawData || 'No details available.');
            }
        });
    });
</script>