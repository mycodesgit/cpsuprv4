<script>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#itemauditTable').DataTable({
            "ajax": {
                "url": itemAuditReadRoute,
                "type": "GET",
            },
            destroy: true,
            info: true,
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<button type="button" class="btn btn-sm btn-success view-item-details-btn" ' +
                               'data-payload=\'' + (rawData || '{}') + '\' ' +
                               'data-bs-toggle="modal" data-bs-target="#auditItemDetailsModal">' +
        ...
        $(document).on('click', '.view-item-details-btn', function() {
            ...
            try {
                ...
                $('#jsonPayloadDisplayItem').html(highlightedJson);
            } catch (e) {
                $('#jsonPayloadDisplayItem').text(rawData || 'No details available.');
            }
        });
    });
</script>