<script>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#yearauditTable').DataTable({
            "ajax": {
                "url": yearAuditReadRoute,
                "type": "GET",
            },
            destroy: true,
            info: true,
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<button type="button" class="btn btn-sm btn-success view-year-details-btn" ' +
                               'data-payload=\'' + (rawData || '{}') + '\' ' +
                               'data-bs-toggle="modal" data-bs-target="#auditYearDetailsModal">' +
        ...
        $(document).on('click', '.view-year-details-btn', function() {
            ...
            try {
                ...
                $('#jsonPayloadDisplayYear').html(highlightedJson);
            } catch (e) {
                $('#jsonPayloadDisplayYear').text(rawData || 'No details available.');
            }
        });
    });
</script>