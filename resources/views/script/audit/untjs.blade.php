<script>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#unitauditTable').DataTable({
            "ajax": {
                "url": unitAuditReadRoute,
                "type": "GET",
            },
            destroy: true,
            info: true,
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<button type="button" class="btn btn-sm btn-success view-unit-details-btn" ' +
                               'data-payload=\'' + (rawData || '{}') + '\' ' +
                               'data-bs-toggle="modal" data-bs-target="#auditunitDetailsModal">' +
        ...
        $(document).on('click', '.view-unit-details-btn', function() {
            ...
            try {
                ...
                $('#jsonPayloadDisplayUnit').html(highlightedJson);
            } catch (e) {
                $('#jsonPayloadDisplayUnit').text(rawData || 'No details available.');
            }
        });
    });
</script>